    ...
    if d_cmd=='1' :
        if input('确认输入"ok"回车后，开始自动复制：')=='ok':
            d_copysheets(\
                ...
                ['查询4_1_本周清单_除异常工单'],\
                r'E:\2017工作-ET\开网优化\进度统计\统计工具\access导出文件夹\输出模板\附件二：LTE开网优化状态库挂起工单2018xxxx.xlsx',\
                ['开网优化挂起工单'])
            d_copysheets(\
                r'E:\2017工作-ET\开网优化\进度统计\统计工具\access导出文件夹\查询2-123 建设类_本周清单.xlsx',\
                ['查询2_1_建设类_本周清单', '查询2_2_建设类_新增', '查询2_3_建设类_解除'],\
                r'E:\2017工作-ET\开网优化\进度统计\统计工具\access导出文件夹\输出模板\附件：开网优化项目_建设类_挂起工单清单2018xxxx.xlsx',\
