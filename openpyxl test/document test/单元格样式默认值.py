...
border = Border(left=Side(border_style=None,            #边框设置：单线：Side(border_style="thin", color="000000")
                           color='FF000000'),           #双线：Side(border_style="double", color="000000")
                 ...
                 outline=Side(border_style=None,        #外框
                              color='FF000000'),
                 vertical=Side(border_style=None,       #内部垂直框？
                               color='FF000000'),
                 horizontal=Side(border_style=None,     #内部水平框？
                                color='FF000000')
                )
